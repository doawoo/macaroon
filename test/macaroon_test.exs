defmodule MacaroonTest do
  ...
  test "Add a third party caveat to a macaroon (Macaroon.add_third_caveat/5)" do
    ...
    c = m.third_party_caveats
    |> List.first()

    vid = c.verification_key_id
    |> Base.encode16()
    |> String.downcase()

    assert vid == "00000000000000000000000000000000000000000000000015c6c99d220519b26a16d216eca12d5bccc996ab92dc199ef0e7d30c429aea6b2266eef690fa081f0e5e9124ff31f3cc"
  ...
  test "Two macaroons with the same third party caveat should use different nonces (Macaroon.add_third_caveat/5)" do
    m1 = Macaroon.create_macaroon(@m_location, @m_id, @m_secret)
    ...
    m2 = Macaroon.create_macaroon(@m_location, @m_id, @m_secret)
    |> Macaroon.add_third_party_caveat(@t_location, @t_id, @t_secret)
